...
public class SNPlayerListener implements Listener {
	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		...
		if (action.equals(Action.RIGHT_CLICK_BLOCK)
				&& player.getTargetBlock((Set<Material>) null,20).getType() == Material.CLAY) {
					...
					for (int y = blockLoc.getBlockY() - 2; y < blockLoc.getBlockY() + 3; y++) {
						for (int z = blockLoc.getBlockZ() - 2; z < blockLoc.getBlockZ() + 3; z++) {
							...
							if (newBlock.getType().equals(Material.OAK_SIGN)
									...
									|| newBlock.getType().equals(Material.SPRUCE_SIGN)
									|| newBlock.getType().equals(Material.SPRUCE_WALL_SIGN)
									|| newBlock.getType().equals(Material.ACACIA_SIGN)
									|| newBlock.getType().equals(Material.ACACIA_WALL_SIGN)
									|| newBlock.getType().equals(Material.BIRCH_SIGN)
									|| newBlock.getType().equals(Material.BIRCH_WALL_SIGN)
									|| newBlock.getType().equals(Material.CRIMSON_SIGN)
									|| newBlock.getType().equals(Material.CRIMSON_WALL_SIGN)
									|| newBlock.getType().equals(Material.DARK_OAK_SIGN)
									|| newBlock.getType().equals(Material.DARK_OAK_WALL_SIGN)
									|| newBlock.getType().equals(Material.JUNGLE_SIGN)
									|| newBlock.getType().equals(Material.JUNGLE_WALL_SIGN)
									|| newBlock.getType().equals(Material.MANGROVE_SIGN)
									|| newBlock.getType().equals(Material.MANGROVE_WALL_SIGN)
									|| newBlock.getType().equals(Material.WARPED_SIGN)
									|| newBlock.getType().equals(Material.WARPED_WALL_SIGN)) {
